...
/// <summary>M420: code-behind forwards pointer input on the particle preview to the embedded viewport
/// camera, the same contract the Particle Editor's preview uses (LMB orbit · MMB pan · wheel zoom).</summary>
