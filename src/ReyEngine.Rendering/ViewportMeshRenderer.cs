...
public sealed class ViewportMeshRenderer : IDisposable
{
    ...
    private int _mTint;                                            // M34: material TintColor (rgba)
    ...
    private struct SubmeshDraw
    {
        ...
        public Vector4 Tint;            // M34: material TintColor (rgba), multiplies diffuse; default 1,1,1,1
...
uniform vec4 uTint;            // M34: material TintColor (rgba), multiplies diffuse like the real shaders; 1,1,1,1 = none
...
void main() {
    ...
    float alpha = ((uHasTex == 1) ? tex.a : 1.0) * uTint.a;
